...
try {
    ...
    $mail->setFrom('info@esencianaxiansuites.com', 'Message from Esencia');             // Email Address and Name FROM
    $mail->addAddress('feniap22@gmail.com', 'Fenia Petri');                          // Email Address and Name TO - Name is optional 
    $mail->addReplyTo('info@esencianaxiansuites.com', 'Message from Esencia');       // Email Address and Name NOREPLY
    $mail->isHTML(true);                                                       
   ...
   // Setup html content
    ...
    $e_content_confirm = "Thank you for your interest! A member of our team will be in touch with you shortly.";
